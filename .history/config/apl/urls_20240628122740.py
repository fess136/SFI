...
urlpatterns = [
    ...
    path('presentaciones/crear', MarcaCreateView.as_view(), name = 'crear_presentacion'),
    path('presentaciones/editar/<int:pk>', MarcaUpdateView.as_view(), name = "editar_presentacion"),
    path('presentaciones/borrar/<int:pk>', MarcaDeleteView.as_view(), name = 'borrar_presentacion'),
    #Modulo Marcas
    ...
    #Modulo Compras
    path('compras/listar',CompraListView.as_view(), name = "listar_compra"),
    ...
    path('identificador/editar/<int:pk>', IdentificadorUpdateView.as_view(), name = 'editar_identificador'),
    path('identificador/borrar/<int:pk>', IdentificadorDeleteView.as_view(), name = 'borrar_identificador'),
