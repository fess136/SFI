...
class Ventas(models.Model):
    ...
    producto = models.ForeignKey(Productos,on_delete=models.PROTECT)
    empleado= models.ForeignKey(Empleados,on_delete=models.PROTECT SET_NULL)
    cliente = models.ForeignKey(Clientes,on_delete=models.PROTECT)
    administrador = models.ForeignKey(Administradores,on_delete=models.PROTECT SET NULL)