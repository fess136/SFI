...
class Compras(models.Model):
    ...
    metodo_pago =models.ForeignKey(Metodo_Pago,on_delete=models.PROTECT,null=True)
    producto = models.ForeignKey(Productos,on_delete=models.PROTECT,null=True)
    proveedor = models.ForeignKey(Proveedores,on_delete=models.PROTECT,null=True)
