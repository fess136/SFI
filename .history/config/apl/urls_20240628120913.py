...
urlpatterns = [
    ...
    path('metodos/crear', ClienteCreateView.as_view(), name = 'crear_cliente'),
    path('metodos/editar/<int:pk>', ClienteUpdateView.as_view(), name = "editar_cliente"),
    path('metodos/borrar/<int:pk>', ClienteDeleteView.as_view(), name = 'borrar_cliente'),
    #Modulo Clientes
