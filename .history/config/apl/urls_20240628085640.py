...
urlpatterns = [
    ...
    path('clientes/editar/<int:pk>', AdministradorUpdateView.as_view(), name = "editar_administrador"),
    path('clientes/borrar/<int:pk>', AdministradorDeleteView.as_view(), name = 'borrar_administrador'),
    #Modulo Compras
